  ...
  class Active extends Command {
      ...
      execute(config) {
          ...
          request('https://api.iextrading.com/1.0/stock/market/list/mostactive', { json: true }, (err, res, body) => {
            ...
            msg.channel.send({embed: {color: 1687175,title: "US Equity Most Active",
            fields: [{
                name: body[0].symbol,
                value: getValue(0),
                  "inline": true
